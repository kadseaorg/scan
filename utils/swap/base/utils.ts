...
export const getEVMContract = (abi: any, address: string, web3: Web3): any => {
	return new web3!.eth.Contract(abi as unknown as AbiItem as any, address, {})
}
...
export const getTokenChainPathReverse = (
	tokenChain: TokenInfoFormatted[],
	feeChain: number[],
): string => {
