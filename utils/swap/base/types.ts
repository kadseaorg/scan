...
const initialChains: BaseChain[] = [
	...
	},
	{
		...
		scanUrl: 'https://testnet-scan.kadseachain.io/',
		scanName: 'kadsea testnet explorer',
		vmType: 'EVM',
		rpcUrl: 'https://testnet-rpc.kadseachain.io',
	},
